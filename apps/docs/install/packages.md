...
|---|---|---|
| [`@anchor-cctp/core-sdk`](https://www.npmjs.com/package/@anchor-cctp/core-sdk) | `npm install @anchor-cctp/core-sdk` | Settle deposits in a backend with `receive()` |
| [`@anchor-cctp/cli`](https://www.npmjs.com/package/@anchor-cctp/cli) | `npm install -g @anchor-cctp/cli` | Run `init`, `listen`, `verify`, `domains` from a terminal |

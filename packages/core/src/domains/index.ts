...
export const CCTP_DOMAINS: Readonly<Record<number, DomainMeta>> = {
  ...
  9: { domainId: 9, chain: 'aptos', name: 'Aptos', networkType: 'Move' },
  ...
  15: { domainId: 15, chain: 'monad', name: 'Monad', networkType: 'EVM' },
  16: { domainId: 16, chain: 'sei', name: 'Sei', networkType: 'EVM' },
  17: { domainId: 17, chain: 'bnb', name: 'BNB Smart Chain', networkType: 'EVM' },
  ...
  26: { domainId: 26, chain: 'arc', name: 'Arc', networkType: 'EVM' },
  ...
  33: { domainId: 33, chain: 'plasma', name: 'Plasma', networkType: 'EVM' },
